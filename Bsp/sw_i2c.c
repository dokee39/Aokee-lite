...
uint8_t
SW_I2C_Read_8addr(sw_i2c_t* d, uint8_t IICID, uint8_t regaddr, uint8_t* pdata, uint8_t rcnt) {
...
uint8_t
SW_I2C_Read_16addr(sw_i2c_t* d, uint8_t IICID, uint16_t regaddr, uint8_t* pdata, uint8_t rcnt) {
    uint8_t returnack = TRUE;
    uint8_t index;
...
uint8_t
SW_I2C_Write_8addr(sw_i2c_t* d, uint8_t IICID, uint8_t regaddr, uint8_t* pdata, uint8_t rcnt) {
    uint8_t returnack = TRUE;
    uint8_t index;
...
uint8_t
SW_I2C_Write_16addr(sw_i2c_t* d, uint8_t IICID, uint16_t regaddr, uint8_t* pdata, uint8_t rcnt) {
    uint8_t returnack = TRUE;
    uint8_t index;
