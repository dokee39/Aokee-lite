...
static GPIO_TypeDef* const SW_I2C_SCL_PORT = GPIOB;
static GPIO_TypeDef* const SW_I2C_SDA_PORT = GPIOB;
static const uint16_t SW_I2C_SCL_PIN = GPIO_PIN_6;
static const uint16_t SW_I2C_SDA_PIN = GPIO_PIN_7;
...
static int sw_i2c_port_io_ctl(hal_io_opt_e opt, void *param)
{
    ...
    case HAL_IO_OPT_SET_SDA_HIGH:
        GPIO_SetBits(SW_I2C_SDA_PORT, SW_I2C_SDA_PIN);
        break;
    case HAL_IO_OPT_SET_SDA_LOW:
        GPIO_ResetBits(SW_I2C_SDA_PORT, SW_I2C_SDA_PIN);
        break;
    case HAL_IO_OPT_GET_SDA_LEVEL:
        ret = GPIO_ReadInputDataBit(SW_I2C_SDA_PORT, SW_I2C_SDA_PIN);
        break;
    ...
    case HAL_IO_OPT_SET_SCL_HIGH:
        GPIO_SetBits(SW_I2C_SCL_PORT, SW_I2C_SCL_PIN);
        break;
    case HAL_IO_OPT_SET_SCL_LOW:
        GPIO_ResetBits(SW_I2C_SCL_PORT, SW_I2C_SCL_PIN);
        break;
    case HAL_IO_OPT_GET_SCL_LEVEL:
        ret = GPIO_ReadInputDataBit(SW_I2C_SCL_PORT, SW_I2C_SCL_PIN);
        break;
